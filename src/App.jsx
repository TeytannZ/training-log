      ...
      <div className={sheetClass} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-4">
          <Field label="الاسم بالإنجليزية">
            ...
            {!isNew && <p className="text-xs text-ink-faint mt-1">تعديل الاسم هنا يبقيه نفس العنصر في المكتبة (لا ينشئ نسخة جديدة) — لكنه لا يغيّر أسماء تمارين محفوظة مسبقًا داخل خطط المستخدمين.</p>}
          </Field>
